...
export default function Dashboard() {
  ...
  // View mode
  const [activeTab, setActiveTab] = useState<'orders' | 'estimator'>('estimator');
        ...
        <div className="max-w-7xl mx-span mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <nav className="flex items-center bg-slate-100 p-1 rounded-lg">
              ...
              >
                <Zap className="w-3.5 h-3.5 text-amber-500" /> Sales Estimator
              </button>
              <button
              ...
              >
                <ShoppingBag className="w-3.5 h-3.5 text-blue-500" /> Orders Dashboard
              </button>
            </nav>
            ...
            <button
              ...
              className="hidden md:flex items-center gap-2 text-xs bg-slate-100 hover:bg-slate-200 text-slate-700 px-3 py-1.5 rounded-md font-medium transition"
            >
